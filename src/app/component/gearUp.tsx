...
// //           <div key={product.id} className="w-1/2 flex-shrink-0 group cursor-pointer">
// //             <div className="aspect-square relative mb-2 bg-white">
// //               <Image
// //                 src={product.image}
// //                 alt={product.name}
// //                 fill
...
// //   return (
// //     <div className="w-[1344px] h-[561px] mx-auto overflow-hidden">
...
//   return (
//     <div className="w-full max-w-[666px] h-[509px]">
//       <div className="flex items-center justify-between mb-4">
//         <h2 className="text-xl font-semibold">{title}</h2>
//         <div className="flex gap-2">
//           <Button
...
//       <div className="flex gap-4">
//         {products.slice(currentIndex, currentIndex + 2).map((product) => (
//           <Card key={product.id} className="w-[300px] h-[393px] flex-shrink-0 group cursor-pointer">
...
//       description: "Men's Short-Sleeve Running Top",
//       price: 3895,
//       image: require("../../../public/nphoto/gear1.png"),
//     },
//     {
//       id: "2",
//       name: "Nike Dri-FIT Challenger",
//       description: "Men's 18cm (approx.) 2-in-1 Versatile Shorts",
//       price: 2495,
//       image: require("../../../public/nphoto/gear2.png"),
//     },
//     {
//       id: "3",
//       name: "Nike Dri-FIT ADV Run Division",
...
//       description: "Women's Long-Sleeve Running Top",
//       price: 5295,
//       image: require("../../../public/nphoto/gear4.png"),
//     },
//     {
//       id: "6",
//       name: "Nike Fast",
//       description: "Women's Mid-Rise 7/8 Running Leggings with Pockets",
//       price: 3795,
//       image: require("../../../public/nphoto/gear3.png"),
//     },
//     {
//       id: "7",
//       name: "Nike Dri-FIT ADV TechKnit Ultra",
